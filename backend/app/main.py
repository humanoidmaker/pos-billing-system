...
from app.api import auth, products, categories, customers, bills, settings as settings_api
...
async def stats():
    ...
    return {"stats": {"today_revenue": d["revenue"], "today_bills": d["count"], "total_products": tp, "total_customers": tc}}
